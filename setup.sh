...
echo ""
echo "  5. Edit and Regenerate config"
echo "     Edit accessToken in dimension/config.yaml and run ./setup.sh (all answers N)"
echo "     Then run: docker compose up -d dimension --force-recreate"
echo ""
